...
export default function NewBook({authorList}) {
  ...
  const [selectedAuthor, setSelectedAuthor] = useState({ id: null});    // just author_id - if want to create a author need to have a option to create a author to create a author
